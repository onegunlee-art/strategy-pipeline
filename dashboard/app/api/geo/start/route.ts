...
- strategy_low: 가능성이 낮을 때(<40%), 확률을 65%+ 로 끌어올리기 위한 전략 아이디어. FA·이코노미스트 기사에서 발견한 미활용 기회를 근거로 **반드시 번호 매긴 3~5개 항목**으로 작성 (예: "1. ... 제안\n2. ... 권고\n3. ..."). 각 항목은 "~을 고려할 것을 제안", "~를 권고", "~방안을 검토" 등 제안·권고 어조로 작성. 선동적·명령형 표현 금지.
